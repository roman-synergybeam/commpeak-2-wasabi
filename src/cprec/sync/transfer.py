...
from cprec.db.models.core import Recording, StorageDestination
from cprec.logging import get_logger
from cprec.storage.base import ObjectMeta
from cprec.storage.commpeak import CommPeakSource
from cprec.storage.errors import ErrorClass, TransferError
from cprec.storage.wasabi import WasabiDestination, destination_key, sidecar_key
    ...
    *,
    ...
    upload = await dest.put_stream(
        ...
        metadata={
            ...
            # the database.
            "cprec-source-key": recording.source_key[:1024],
            "cprec-call-uuid": recording.call_uuid or "",
            "cprec-match": recording.match_method or "",
        },
    )
