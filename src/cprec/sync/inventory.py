...
from cprec.commpeak.correlate import CdrCandidate, MatchMethod, correlate
from cprec.commpeak.keyparse import ParsedKey, iter_hour_prefixes, parse_key
from cprec.db.base import JobKind, RecordingState
from cprec.db.models.core import CommPeakConnection, Recording
...
async def scan_hour(
    ...
    *,
    ...
    """
    from cprec.commpeak.keyparse import hour_prefix
