...
thin, well-named configurations of it (see :mod:`cprec.storage.commpeak` and
:mod:`cprec.storage.wasabi`).
...
from cprec.storage.base import (
    ObjectDestination,
    ObjectMeta,
    ObjectRef,
    ObjectSource,
...
from cprec.storage.errors import ErrorClass, TransferError, classify_exception
...
class S3Client(ObjectSource, ObjectDestination):
    ...
    async def head(self, key: str) -> ObjectMeta:
        ...
        return ObjectMeta(
            ...
            checksum_sha256=(resp.get("Metadata") or {}).get("cprec-sha256"),
    ...
    async def _put_multipart(
        ...
        with contextlib.suppress(Exception):
            ...
            await self.client.copy_object(
                ...
                Metadata={**meta, "cprec-sha256": hexdigest},
