...
from cprec.db.session import dispose_engine, get_engine, get_sessionmaker
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    try:
        ...
        async with factory() as session:
            await reconfigure_from_settings("cprec-api", session)
...
def create_app() -> FastAPI:
    ...
    from cprec.web.routes import router as web_router
